...
import chenxi.shangguan.messageciher_v202.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ui.txtOldVer.setOnClickListener {
            val i = Intent(this, MainActivity_old::class.java)
            startActivity(i)
        }
    }
}